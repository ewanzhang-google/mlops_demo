...
def svm_comp( 
    ...
    fpr, tpr, thresholds = roc_curve(y_true=test_df_label, y_score=pred_prob[:,1], pos_label=True)
    ...
    metrics_params.log_metric("svm_f1_test_score", (f1_score(test_df_label, pred)))    
...
def bt_comp( 
    ...
    metrics_params.log_metric("bt_f1_test_score", (f1_score(test_df_label, pred)))    
